...
const cvsFiltration = (arr) => {
  return arr
    .filter((element) => element.yearsOfExperience > 4 && element.tech == "JS")
    .map((element) => {
      if (element.firstName === null) {
        return { fullName: element.LastName, tech: element.tech };
      } else if (element.LastName === null) {
        return { fullName: element.firstName, tech: element.tech };
      } else {
        return {
...
const skillComparison = (arr1, arr2) => {
  ...
  arr2
    .filter((element) => !arr1.includes(element))
    .forEach((value) => newArr.push(value));
  return newArr;
};
// -------------------------------------------------------------------------------------------------------
