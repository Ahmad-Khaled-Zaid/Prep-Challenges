...
const LastWord = (str) => {
  ...
  return str.slice(str.lastIndexOf(lastItem), str.length);
};
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
  ...
  newArray.indexOf("I") !== -1
    ? newArray.splice(newArray.indexOf("I"), 1, "We")
    : 0;
  newArray.indexOf("am") !== -1
    ? newArray.splice(newArray.indexOf("am"), 1, "are")
    : 0;
  newArray.indexOf("was") !== -1
    ? newArray.splice(newArray.indexOf("was"), 1, "were")
    : 0;
