...
const customerAndAge = (obj) => {
  ...
  for (let element in obj) {
    array.push(`Customer Name :${element} , Age :${obj[element]}`);
  }
  return array;
};
// -------------------------------------------------------------------------------------------------------
...
const getEntries = (obj) => {
  let array = [];
  for (let props of Object.entries(obj)) {
    array.push(`${props[0]}: ${props[1]}`);
  }
  return array;
};
// -------------------------------------------------------------------------------------------------------
...
const getInfo = (arr) => {
  ...
  for (let object of arr) {
    for (let courses in object) {
      if (courses == "course") {
        coursesName.push(object[courses]);
      }
    }
    //-----------------------
    let newArr = [];
